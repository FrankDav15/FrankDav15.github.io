...
if ($name == "") {
    ...
    $headers .= 'From:  Eternal Glow <eternalglow.medicalaesthetic@gmail.com>' . "\r\n";
    $headers .= 'cc: eternalglow.medicalaesthetic@gmail.com' . "\r\n";
    $headers .= 'bcc: eternalglow.medicalaesthetic@gmail.com' . "\r\n";
    mail($to, $subject, $_message, $headers, '-f eternalglow.medicalaesthetic@gmail.com');
